...
<div class="container">
<h1>📖 TXT转电子书</h1>
<p class="subtitle">自动识别卷/章 · 多级标题 · 支持 EPUB / KEPUB / AZW3</p>
...
<div class="footer-note">AZW3 由 <a href="https://github.com/zacharydenton/boko" target="_blank">boko</a> 提供转换支持</div>
</div>
<script type="module">
import init, { epub_to_azw3 } from './pkg/boko.js';

let bokoReady = false;
try { await init(); bokoReady = true; } catch (e) { console.warn('boko 加载失败，AZW3 转换不可用'); }
...
try{
  ...
  if(bokoReady && fmt==='azw3'){
    var inputData = new Uint8Array(await eb.arrayBuffer());
    var outputData = epub_to_azw3(inputData);
